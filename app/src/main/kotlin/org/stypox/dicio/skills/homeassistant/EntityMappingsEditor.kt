...
/**
 * Dialog for adding or editing a single entity mapping.
 * Includes a "Pick" button that fetches entities from Home Assistant for selection.
 */
@Composable
...
/**
 * Dialog that lists all Home Assistant entities with search/filter,
 * allowing the user to pick one for an entity mapping.
 */
@Composable
